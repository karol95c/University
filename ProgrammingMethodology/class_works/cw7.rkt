...
(define (list-elements t)
  (cdr t))

(define (make-list args)
  (if (null? args)
      null-expr
      (cons-cons (car args) (make-list (cdr args)))))
...
(define (eval-env e env)
  (cond [(null-expr? e) null]
        ...
        [(pair-expr? e)
         (pair? (eval-env (pair-expr-elements e) env))]
        [(list-expr? e)
         (eval-env (make-list (list-elements e)) env)]
        [(lambda? e)
